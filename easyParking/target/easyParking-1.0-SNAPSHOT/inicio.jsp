                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <div class="float-right">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="#" ng-click="cerrarSesion()"><button class="btn color1"><i class="fa fa-power-off"></i> Cerrar Sesión</button></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" required ng-model="documento" class="form-control" maxlength="11" placeholder="Número Identificación" aria-describedby="nombrePropietario"/>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Número Celular *</label>
                                    <input type="text" required ng-model="celular" class="form-control" maxlength="10" placeholder="Número Celular" aria-describedby="nombrePropietario"/>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Placa Vehículo *</label>
                                    <input type="text" maxlength="7" required ng-model="placa" class="form-control" placeholder="Placa vehículo" aria-describedby="nombrePropietario"/>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Plaza Aparcamiento *</label>
                                    <input type="number" required ng-model="plaza" class="form-control" placeholder="Placa vehículo" aria-describedby="nombrePropietario"/>
                                </div>
