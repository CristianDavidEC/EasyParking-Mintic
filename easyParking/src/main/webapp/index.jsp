<%-- Document : regParqueo Created on : 29/09/2021, 12:03:29 PM Author : Natan
Ortiz Lozano --%> <%@page contentType="text/html" pageEncoding="UTF-8"%> <%@
page import="java.io.*,java.util.*" %> <%@ page
    import="javax.servlet.*,java.text.*" %>
    <!DOCTYPE html>
    <html>
        <head>
            ...
            <link
                rel="stylesheet"
                href="font/font-awesome-4.7.0/css/font-awesome.css"
                />
        </head>
        <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" ng-click="listarRegistros()"
                                       >Lista Registros</a
                                    >
                                </li>
                            </ul>
                            ...
                            <tr ng-repeat="registro in regestado1">
                                ...
                                <td style="cursor: pointer">
                                    <a
                                        ...
                                        href=""
                                        aria-label="Sign Out"
                                        ng-click="actualizarRegistro(registro.id_registro_parqueo, registro.fecha_ingreso)"
                                        >
                                ...
                                <td style="cursor: pointer">
                                    <a
                                        ...
                                        href=""
                                        aria-label="Delete"
                                        ng-click="borrarRegistro(registro.id_registro_parqueo)"
                                        >
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input
                                            ...
                                            aria-describedby="nombrePropietario"
                                            />
                                    </div>
                                    <div class="mb-3">
